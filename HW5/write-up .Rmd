...
2)
Based on the test error of neural network method, I think that newural network method is better than the additive model.
```{r,include=FALSE}
set.seed(12345)
data("spam")
...
test_error_nn = round(mean(test_spam_data$spam != nn_pred),4)
...
train_error_radial <- (102+56) / (558+56+102+284)
